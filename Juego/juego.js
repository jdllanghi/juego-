...
let jugador1 = new Juego("Player1", 3, parseInt(prompt("Ingrese un numero del 1 a 7"), 10));
let jugador2 = new Juego("Player2", 3, parseInt(prompt("Ingrese un numero del 1 a 7"), 10));
